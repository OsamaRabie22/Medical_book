...
import 'payment_confirmation_page.dart'; // إضافة الـ import
...
Widget _buildDoctorInfoSection(BuildContext context, double scale, bool isTablet) {
return Container(
...
CircleAvatar(
radius: isTablet ? 45 * scale : 35 * scale,
...
Widget _buildClinicAddressSection(BuildContext context, double scale, bool isTablet) {
return Container(
padding: EdgeInsets.all(isTablet ? 20 * scale : 16 * scale),
decoration: BoxDecoration(
color: AppColors.white,
...
Widget _buildDateSelectionSection(BuildContext context, double scale, bool isTablet) {
return Container(
padding: EdgeInsets.all(isTablet ? 20 * scale : 16 * scale),
decoration: BoxDecoration(
color: AppColors.white,
...
if (index < dateOptions.length - 1) SizedBox(width: 12 * scale),
],
);
}).toList(),
SizedBox(width: 4 * scale),
...
Widget _buildTimeSelectionSection(BuildContext context, double scale, bool isTablet) {
return Container(
padding: EdgeInsets.all(isTablet ? 20 * scale : 16 * scale),
decoration: BoxDecoration(
color: AppColors.white,
...
Widget _buildBookingDetailsSection(BuildContext context, double scale, bool isTablet) {
return Container(
padding: EdgeInsets.all(isTablet ? 20 * scale : 16 * scale),
decoration: BoxDecoration(
color: AppColors.white,
...
Widget _buildConfirmButton(BuildContext context, double scale, bool isTablet) {
return SizedBox(
width: double.infinity,
child: ElevatedButton(
