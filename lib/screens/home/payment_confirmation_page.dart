...
_buildConfirmationDetail("Date", selectedDateText, scale, isTablet),
_buildConfirmationDetail("Time", selectedTime, scale, isTablet),
_buildConfirmationDetail("Consultation Fee", "EGP ${consultationFee.toStringAsFixed(0)}", scale, isTablet),
...
Widget _buildConfirmationDetail(String label, String value, double scale, bool isTablet) {
return Padding(
